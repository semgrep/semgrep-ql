...
(**
    Functions for parsing ql programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a ql program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.ql, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a ql program from a file into a typed OCaml CST.
